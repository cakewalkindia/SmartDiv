...
var InterventionUI = /** @class */ (function () {
    function InterventionUI() {
        this.tabDirection = "right";
        //this.addMainTable();
    }
    InterventionUI.prototype.addMainTable = function () {
        var _this = this;
        ...
        if (this.currentTD == null) {
            ...
            var txt1_1 = document.getElementById("txtEdit");
            txt1_1.addEventListener("keydown", function (e) { return _this.onTab(txt1_1, e); });
            txt1_1.addEventListener("keyup", function (e) { return _this.onKeyUp(txt1_1, e); });
            ...
            if (this.currentTD.attr('fieldType') == 'text') {
                var objT = new MyTextField("Intervention", "txtEdit", this.currentTD);
                if (objT) {
                    objT.CreateTextField();
                }
            }
            else {
                var objT = new MyDropdownField("Intervention", "txtEdit", this.currentTD);
                if (objT) {
            ...
            for (var i = 0; i < lstTD.length; i++) {
                lstTD[i].addEventListener('click', function (e) { return _this.onTDClick(lstTD[i], e); });
            }
        }
    };
    InterventionUI.prototype.onTDClick = function (txtFld, e) {
        if (e.currentTarget) {
    ...
    InterventionUI.prototype.onTab = function (txtFld, e) {
        if (e.keyCode == 9) {
            var txt = $(txtFld);
    ...
    InterventionUI.prototype.onKeyUp = function (txtFld, e) {
